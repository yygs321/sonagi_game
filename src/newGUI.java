...
public class newGUI extends JPanel{
    ...
    public newGUI(String id, String Level) throws IOException, ParseException{
        ID=id;
        ...
        WordAndTimer wordtimer = new WordAndTimer(Level);
        
        

        wordtimer.word.setBackground(Color.white);
        wordtimer.word.setBounds(0, 80, 800, 400);
        add(wordtimer.word);
        ...
        wordtimer.Timer.setBounds(340, 10, 150, 150);
        add(wordtimer.Timer);
        ...
        stopB.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(e.getSource()==stopB){
                    ...
                    wordtimer.rain.suspend();
                    wordtimer.play.suspend();
                    ...
                    }else
                    {
                        ...
                        wordtimer.rain.resume();
                        wordtimer.play.resume();
                    }
                }
        ...
        answer.addKeyListener(new KeyListener(){
            ...
            public void keyPressed(KeyEvent e) {
            	if(e.getKeyCode()==e.VK_ENTER) {
                    for (int i = 0; i < num; i++) {
                        if (answer.getText().equals(wordtimer.RandomWords.get(i))) {
                        	wordtimer.label[i].setVisible(false);
                            score++;
